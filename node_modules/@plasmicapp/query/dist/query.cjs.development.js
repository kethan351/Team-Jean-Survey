...
var useSWR__default = _interopDefault(useSWR);
...
var mutateAllKeys = function mutateAllKeys() {
  if (__SWRConfig) {
    var _SWRConfig = __SWRConfig,
      cache = _SWRConfig.cache,
...
function getPlasmicDefaultSWROptions() {
  return {
...
function usePlasmicQueryData(key, fetcher) {
  var prepassCtx = React.useContext(PrepassContext);
  var opts = getPlasmicDefaultSWROptions();
  if (prepassCtx) {
  ...
  var config = useSWR.useSWRConfig();
  React.useEffect(function () {
    __SWRConfig = config;
  }, [config]);
  var wrappedFetcher = React.useMemo(function () {
    return wrapLoadingFetcher(fetcher);
  }, [fetcher]);
  var resp = useSWR__default(key, wrappedFetcher, opts);
  if (resp.data) {
    return {
      data: resp.data
    };
...
function useMutablePlasmicQueryData(key, fetcher, options) {
  var prepassCtx = React.useContext(PrepassContext);
  var opts = _extends({}, getPlasmicDefaultSWROptions(), options);
  if (prepassCtx) {
    opts.suspense = true;
  }
  var config = useSWR.useSWRConfig();
  ...
  var fetcherWrapper = React.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    var _args = arguments;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return wrapLoadingFetcher(fetcher).apply(void 0, _args);
          case 4:
  ...
  var _useSWR = useSWR__default(key, fetcherWrapper, opts),
...
function PlasmicQueryDataProvider(props) {
  var children = props.children,
    ...
    prefetchedCache = props.prefetchedCache;
  var prepass = React.useContext(PrepassContext);
  if (prepass) {
    // If we're in prepass, then there's already a wrappign SWRConfig;
    // don't interfere with it.
    return React.createElement(React.Fragment, null, children);
  } else {
    return React.createElement(useSWR.SWRConfig, {
      value: {
...
var PrepassContext = /*#__PURE__*/React.createContext(false);
function PlasmicPrepassContext(props) {
  var cache = props.cache,
    children = props.children;
  return React.createElement(PrepassContext.Provider, {
    value: true
  }, React.createElement(useSWR.SWRConfig, {
    value: {
...
function usePlasmicDataConfig() {
  return useSWR.useSWRConfig();
}
var loadingCount = 0;
var listeners = [];
/**
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            loadingCount += 1;
            _context2.prev = 2;
            res = fetcher.apply(void 0, _args2);
...
exports.PlasmicPrepassContext = PlasmicPrepassContext;
exports.PlasmicQueryDataProvider = PlasmicQueryDataProvider;
exports.addLoadingStateListener = addLoadingStateListener;
exports.useMutablePlasmicQueryData = useMutablePlasmicQueryData;
exports.usePlasmicDataConfig = usePlasmicDataConfig;
exports.usePlasmicQueryData = usePlasmicQueryData;
exports.wrapLoadingFetcher = wrapLoadingFetcher;
//# sourceMappingURL=query.cjs.development.js.map
