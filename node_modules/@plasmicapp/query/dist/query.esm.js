...
function usePlasmicQueryData(key, fetcher) {
  ...
  var resp = useSWR(key, wrappedFetcher, opts);
  if (resp.data) {
    return {
      data: resp.data
    };
...
function useMutablePlasmicQueryData(key, fetcher, options) {
  ...
  var _useSWR = useSWR(key, fetcherWrapper, opts),
...
export { PlasmicPrepassContext, PlasmicQueryDataProvider, addLoadingStateListener, useMutablePlasmicQueryData, usePlasmicDataConfig, usePlasmicQueryData, wrapLoadingFetcher };
